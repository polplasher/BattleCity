...
class Hud extends Phaser.Scene {
    ...
    graphics.fillRect(0, 0, this.START_X, BORDER_SIZE);

    
    graphics.fillRect(0, GAME_SIZE.HEIGHT - BORDER_SIZE, this.START_X, BORDER_SIZE);

    
    graphics.fillRect(0, 0, BORDER_SIZE, GAME_SIZE.HEIGHT);
